...
namespace DigitalRuby.RainMaker
{
    public class BaseRainScript : MonoBehaviour
    {
        ...
        [Tooltip("Light rain looping clip")] public AudioClip RainSoundLight;

        [Tooltip("Medium rain looping clip")] public AudioClip RainSoundMedium;

        [Tooltip("Heavy rain looping clip")] public AudioClip RainSoundHeavy;
        ...
        public LoopingAudioSource audioSourceRainLight;
        public LoopingAudioSource audioSourceRainMedium;
        public LoopingAudioSource audioSourceRainHeavy;
        public LoopingAudioSource audioSourceRainCurrent;
        public LoopingAudioSource audioSourceWind;
            ...
            if (lastRainIntensityValue != RainIntensity)
            {
                ...
                else
                {
                    ...
                    if (audioSourceRainCurrent != newSource)
                    {
                        ...
                        if (_wasMuted)
                        {
                            audioSourceRainCurrent.TargetVolume = 0;
                        }
                        else
                        {
        ...
        protected virtual void Start()
        {
            ...
            if (_wasMuted)
            {
                audioSourceRainLight.TargetVolume = 0;
                audioSourceRainMedium.TargetVolume = 0;
                audioSourceRainHeavy.TargetVolume = 0;
                audioSourceWind.TargetVolume = 0;
            }
            else
            {
                audioSourceRainLight.TargetVolume = 1;
                audioSourceRainMedium.TargetVolume = 1;
                audioSourceRainHeavy.TargetVolume = 1;
                audioSourceWind.TargetVolume = (WindZone.windMain / WindSpeedRange.z) * WindSoundVolumeModifier;
            }
    ...
    public class LoopingAudioSource
    {
        ...
        {
            if (AudioSource.isPlaying &&
                (AudioSource.volume = Mathf.Lerp(AudioSource.volume, TargetVolume, Time.deltaTime)) == 0.0f)
            {
                AudioSource.Stop();
            }
        }
